...
function App(props) {
  ...
  return (
    ...
    <p style={{ zIndex: 99999, fontSize:'8px', position: 'absolute', top: '0', left: '4px', color: 'grey'}}> v 0.4.6.B</p>
    <AuthContextProvider>
    ...
    // start of private routes
            ...
            <PrivateRoute path='/admin/cincinnati-market'
              currentUser={currentUser}
              component={ CinciMarket } />

            <PrivateRoute path='/admin/charlotte-market'
              currentUser={currentUser}
              component={ CharMarket } />
