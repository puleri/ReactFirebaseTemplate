...
export default function OwenStarter(props) {
    ...
    const starterDbMatch = () => {
        // setIsLoading(true)
        const q = firebase.firestore().collection('owens-starter')
    ...
    const handleSubmit = () => {
        ...
        var docRef = db.collection("owens-starter").doc(name);
        let wastePercent;
    ...
    const handleCreateNew = () => {
        ...
        db.collection("owens-starter").doc(newData.name).set({
            name: newData.name,
