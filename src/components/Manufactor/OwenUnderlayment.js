...
export default function OwenUnderlayment(props) {
    ...
    const starterDbMatch = () => {
        // setIsLoading(true)
        const q = firebase.firestore().collection('owens-underlayment')
    ...
    const handleSubmit = () => {
        ...
        var docRef = db.collection("owens-underlayment").doc(name);
        let wastePercent;
    ...
    const handleCreateNew = () => {
        ...
        db.collection("owens-underlayment").doc(newData.name).set({
            name: newData.name,
